<%-- 
    Document   : cinemas
    Created on : Dec 2, 2019, 10:23:25 AM
    Author     : Eisha Ahmad
--%>
...
<body class="homepage" style="">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <a class="left carousel-control" href="content/Movie Ticket Booking._files/my.html#myCarousel" role="button" data-slide="prev"> <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span><span class="sr-only">Previous</span> </a>
        <a class="right carousel-control" href="content/Movie Ticket Booking._files/my.html#myCarousel" role="button" data-slide="next"> <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> <span class="sr-only">Next</span> </a>
    </div>
            ...
            <div class="row" style="text-align:center">
                <div class="col-md-6 col-sm-4  wow fadeInDown animated animated animated" data-wow-duration="200ms" data-wow-delay="200ms" style="visibility: visible; animation-duration: 200ms; animation-delay: 200ms;">
                    <div class="feature-wrap">
                        ...
                        <br> <a href="genreUniversal.jsp"><img src="content/Movie Ticket Booking._files/universal.jpg" class="img-responsive img-thumbnail centerd" style="max-width:330px;min-width:330px;max-height:180px;min-height:180px" alt="image"></a> </div>
                ...
                <div class="col-md-6 col-sm-4  wow fadeInDown animated animated animated" data-wow-duration="200ms" data-wow-delay="200ms" style="visibility: visible; animation-duration: 200ms; animation-delay: 200ms;">
                    <div class="feature-wrap">
                        ...
                        <br> <a href="genreCinepax.jsp"><img src="content/Movie Ticket Booking._files/Cinepax_logo.jpg" class="img-responsive img-thumbnail centerd" style="max-width:330px;min-width:330px;max-height:180px;min-height:180px" alt="image"></a> </div>
                    <h2>Cinepax</h2>
                ...
                <div class="col-md-6 col-sm-4  wow fadeInDown animated animated animated" data-wow-duration="200ms" data-wow-delay="200ms" style="visibility: visible; animation-duration: 200ms; animation-delay: 200ms;">
                    <div class="feature-wrap">
                        <br> <a href="genreCinestar.jsp"><img src="content/Movie Ticket Booking._files/cinestar.jpg" class="img-responsive img-thumbnail centerd" style="max-width:330px;min-width:330px;max-height:180px;min-height:180px" alt="image"></a> </div>
                    <h2>Cinestar</h2>
                ...
                <div class="col-md-6 col-sm-4  wow fadeInDown animated animated animated" data-wow-duration="200ms" data-wow-delay="200ms" style="visibility: visible; animation-duration: 200ms; animation-delay: 200ms;">
                    <div class="feature-wrap">
                        <br><a href="genreSuper.jsp"> <img src="content/Movie Ticket Booking._files/supercinema.jpg" class="img-responsive img-thumbnail centerd" style="max-width:330px;min-width:330px;max-height:180px;min-height:180px" alt="image"> </a></div>
                    <h2>Super Cinema</h2>
 ...
 <section id="footer-bg">
    ...
    <!--/#footer-->
    <script src="js/content/Movie Ticket Booking._files/bootstrap.min.js.download"></script>
    <script src="js/content/Movie Ticket Booking._files/jquery.prettyPhoto.js.download"></script>
    <script src="js/content/Movie Ticket Booking._files/jquery.isotope.min.js.download"></script>
    <script src="js/content/Movie Ticket Booking._files/main.js.download"></script>
    <script src="js/content/Movie Ticket Booking._files/wow.min.js.download"></script>
    <script src="js/content/Movie Ticket Booking._files/app.js.download"></script>
    <script src="js/content/Movie Ticket Booking._files/jquery.validate.js.download"></script>
    <script src="js/content/Movie Ticket Booking._files/jquery.dataTables.js.download"></script>
    <script src="js/content/Movie Ticket Booking._files/dataTables.bootstrap.js.download"></script>
    <script src="js/content/Movie Ticket Booking._files/dataTables.responsive.js.download"></script>
    <script src="js/content/Movie Ticket Booking._files/app.js.download"></script>
